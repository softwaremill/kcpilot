...
```bash
# Run the task
kcpilot task test jvm_heap_size_limit <snapshot-path>

# Example
kcpilot task test jvm_heap_size_limit ./kafka-scan-2024-01-15

# With debug logging
RUST_LOG=kcpilot=debug kcpilot task test jvm_heap_size_limit <snapshot-path>
```
