...
```bash
# Run the task
kcpilot task test broker_count_ha <snapshot-path>

# Example
kcpilot task test broker_count_ha ./kafka-scan-2024-01-15

# With debug logging
RUST_LOG=kcpilot=debug kcpilot task test broker_count_ha <snapshot-path>
```
